        ...
        <div class="fields">
            <div class="username">
                <svg fill="#999" viewBox="0 0 1024 1024">
                    ...
                    <input type="username" name = "username" class="user-input" placeholder="username"<?php if($_SERVER["REQUEST_METHOD"] == "POST"):?>value = "<?=$_POST['username'];?>"<?php endif;?>/></div>
            <div class="password">
                <svg fill="#999" viewBox="0 0 1024 1024">
                    ...
                    <input type="password" name="password" class="pass-input" placeholder="password"<?php if($_SERVER["REQUEST_METHOD"] == "POST"):?>value = "<?=$_POST['password'];?>"<?php endif;?> /></div>
          </div>
